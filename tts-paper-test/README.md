...
- **AI Web自动化** — 基于midscene.js + Playwright的视觉驱动网页测试
...
| AI Web自动化 | 项目管理+AI探索+用例生成+测试执行 | `/ai-web-automation` |
...
```
WebExplorerAgent  →  页面结构分析  →  TestGeneratorAgent
   (midscene.js)      (AI视觉)        (LLM生成)
                                             ↓
ExecutionAgent  ←  测试用例  ←  人工审批
(midscene.js+Playwright)    (approve/reject)
```
